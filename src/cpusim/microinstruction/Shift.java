...
public class Shift extends Microinstruction{
     ...
     */
    public Object clone(){
        return new Shift(getName(),getSource(),getDestination(),getType(),getDirection(),getDistance());
    }
    ...
    {
        Assert.That(oldMicro instanceof Shift,
    ...
    public void execute()
    {
        ...
        if (type.get().equals("logical") && direction.get().equals("left")) {
            ...
            Assert.That(type.get().equals("cyclic") &&
