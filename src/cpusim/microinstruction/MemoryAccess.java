...
public class MemoryAccess extends Microinstruction {
     ...
     */
    public Object clone(){
        return new MemoryAccess(getName(),getDirection(),getMemory(),getData(),getAddress());
    }
    ...
    {
        Assert.That(oldMicro instanceof MemoryAccess,
    ...
    public void execute()
    {
        ...
        if (direction.get().equals("read")) {
            ...
            Assert.That(direction.get().equals("write"), "Illegal direction " +
