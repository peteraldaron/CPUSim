...
public class FindReplaceController implements Initializable {
	...
	@FXML private TextField replaceWithTF;
	@FXML private Label statusLabel;

	@FXML private CheckBox caseSensitive;
	@FXML private CheckBox wholeWord;
	@FXML private RadioButton forwardRB;
	@FXML private RadioButton backwardRB;
	 ...
	 * 
	 * @param dc The parent DesktopController.
	 */
	...
	/**
	 * Gives the TextArea of the current tab open, if there
	 * is one. Returns null if not.
	 * 
	 * @return the TextArea of the current tab open.
	 */
	public TextArea validAreaToSearch() {
		if (useConsole) {
		...
		TextArea selectedTextArea = 
				desktop.getTabEditorContollers().get(currTab).getTextArea();
	 ...
	 */
	public static FindReplaceController openFindReplaceDialog(Mediator m, boolean useConsole) {
