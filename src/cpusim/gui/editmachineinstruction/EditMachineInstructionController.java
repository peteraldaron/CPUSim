...
public class EditMachineInstructionController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        Callback<ListView<String>,
            ListCell<String>> cellStrFactory =
            new Callback<ListView<String>, ListCell<String>>() {
                @Override
                public ListCell<String> call(ListView<String> list) {
                    return new cpusim.gui.util.EditingStrListCell();
                }
    ...
    protected void handleOkay(ActionEvent ae){
        ...
        try{
            ...
            Dialogs.showErrorDialog((Stage)newButton.getScene().getWindow(), 
                    ex.getMessage(), "Machine Instruction Error");
        }
    }
