...
public class EditFieldsController implements Initializable {
    ...
    protected void handleDelete(ActionEvent ae){
        ...
        if (containingInstructions.containsKey(selectedField)){
            Dialogs.DialogResponse r;
            r = Dialogs.showConfirmDialog(stage, "The following instructions contain this field:"+
                    ...
                    + "instruction?", "Deleting a field in use");
            if (r == Dialogs.DialogResponse.YES){
    ...
    protected void handleValues(ActionEvent ae){
        ...
        EditFieldNamesController controller = new EditFieldNamesController(this, fieldStage);
