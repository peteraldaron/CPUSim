...
public class RegisterTableController implements Initializable {
    ...
    public RegisterTableController(DesktopController d, ObservableList<Register> register, String title) {
    	desktop = d;
        registers = register;
        this.title = title;
    }
        ...
        Callback<TableColumn<Register,Long>,TableCell<Register,Long>> cellMultiBaseLongFactory =
                new Callback<TableColumn<Register, Long>, TableCell<Register, Long>>() {
                    ...
                    public TableCell<Register, Long> call(
                        ...
                        final EditingMultiBaseStyleLongCell<Register> a = new EditingMultiBaseStyleLongCell<>(base, color);
                    	// Tooltip
    ...
    /**
     * updates the values in the table using a hack
     */
