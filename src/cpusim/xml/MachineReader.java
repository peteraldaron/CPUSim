...
public class MachineReader
    ...
    //added to the current machine instruction's format--backward compatability
    private String currentInstructionFormat;
    private String currentAssemblyFormat;
    ...
    private HashMap windowInfo; //key = module,
    //value = rectangle position of module window
    private HashMap cellSizeInfo; //key = ram,
    //value = cellSize for the ram window
    private HashMap contentBaseInfo; //key = module, value = "Decimal", "Binary",
    //						"Hexadecimal", "Ascii", "Unsigned Dec", "Unicode"
    private HashMap addressBaseInfo; //key = module, value = "Decimal", "Binary",
    //						"Hexadecimal",
    ...
    public void reset() {
        ...
        opcodeLine = null;
        locator = null;
        registerRAMPairs = new Vector<RegisterRAMPair>();
        windowInfo = new HashMap();
        cellSizeInfo = new HashMap();
        contentBaseInfo = new HashMap();
        addressBaseInfo = new HashMap();
        channels = new HashMap();
        currentRegisterArray = null;
        currentRegisterArrayIndex = 0;
        fields = new HashMap<String, Field>();
        chars = new ArrayList<PunctChar>();
    }
     ...
     */
    public void parseDataFromFile(File fileToOpen)
            throws Exception {
        Lax lax = new Lax();
        lax.reset();
        reset();
    ...
    public void startMachine(Attributes alAttrs) {
        ...
        machine = new Machine(name); //has default set of fields
        machine.getFields().clear(); //the fields will be read from the file
...
//        channels.clear();
    ...
    public void endMachine() {
        try {
            MachineInstruction[] instrs = machine.getInstructions().toArray(
    ...
    public void startPunctChar(Attributes attrs) {
        ...
        if (cAsString.length() != 1)
            throw new MachineReaderException(getCurrentLine() +
                    "There must be only one punctuation character per line.");
    ...
    public void startField(Attributes attrs) {
        ...
        Field.Relativity rel =
                Enum.valueOf(Field.Relativity.class, relativityString);
        ...
        if (numBits > 0 && !signed &&
            ...
            throw new MachineReaderException(getCurrentLine() +
                ...
                (defaultValue < -Math.pow(2, numBits - 1) ||
                        defaultValue > Math.pow(2, numBits - 1) - 1))
            throw new MachineReaderException(getCurrentLine() +
                    "The default value of the signed Field \"" + name +
                    "\" must be in the range -(2^" + (numBits - 1) + ") and" +
                    "(2^" + (numBits - 1) + "-1).");

        Field f = new Field(name, type, numBits, rel,
                FXCollections.observableArrayList(new ArrayList<FieldValue>()),
                defaultValue, signed);
        //Field f = new Field();
    ...
    public void startRegisterArray(Attributes attrs) {
        ...
        if (width <= 0 || width > 64) {
            throw new MachineReaderException(
                    getCurrentLine() + "The width of the registers " +
        ...
        try {
            ...
            throw new MachineReaderException(
                    getCurrentLine() + "The length of register "
                            + "array \"" + name + "\" must be an integer, not \"" + lengthString + "\".");
        }
        if (length <= 0) {
            throw new MachineReaderException(
                    getCurrentLine() + "The length of register "
    ...
    public void startConditionBit(Attributes attrs) {
        ...
        if (object == null || !(object instanceof Register)) {
            throw new MachineReaderException(
                    getCurrentLine() + "The register attribute "
        ...
        try {
            ...
            throw new MachineReaderException(
                    getCurrentLine() + "The bit index of condition bit \""
                            + name + "\" must be an integer, not \"" + bitString + "\".");
        }
        if (bit < 0 || bit >= register.getWidth()) {
            throw new MachineReaderException(
                    getCurrentLine() + "The bit index of condition bit \""
                            + name + "\" is " + bit + ", which is out of range.");
        }
    ...
    public void startRAM(Attributes attrs) {
        ...
        try {
            ...
            throw new MachineReaderException(
                    getCurrentLine() + "The length of RAM \""
        ...
        if (cellSizeString == null) //optional field for backward compatibility
            ...
            try {
                ...
                throw new MachineReaderException(
                        getCurrentLine() + "The number of bits of each cell of RAM \""
                                + name + "\" must be an integer, not \"" +
                                lengthString + "\".");
            }
        if (cellSize <= 0 || cellSize > 64) {
            throw new MachineReaderException(
                    getCurrentLine() + "The number of bits of each cell of RAM \""
                            + name + "\" must be a positive integer at most" +
                            " 64, not " + length + ".");
        }
    ...
    public void startIncrement(Attributes attrs) {
        ...
        try {
            ...
            throw new MachineReaderException(
                    getCurrentLine() + "The delta value of the " +
        ...
        if (overflowBitID == null)
            ...
            if (object == null || !(object instanceof ConditionBit)) {
                throw new MachineReaderException(
                        getCurrentLine() + "The overflowBit attribute "
                                + "of Increment microinstruction \"" + name +
                                "\" is not valid.");
            }
        ...
        Increment c = new Increment(name, register, overflowBit, Long.valueOf(delta));
        String id = attrs.getValue("id");
        components.put(id, c);
    ...
    public void startArithmetic(Attributes attrs) {
        ...
        if (object == null || !(object instanceof Register)) {
            throw new MachineReaderException(
                    getCurrentLine() + "The source1 attribute "
        ...
        if (object == null || !(object instanceof Register)) {
            throw new MachineReaderException(
                    getCurrentLine() + "The source2 attribute "
                            + "of Arithmetic microinstruction \"" + name +
                            "\" is not valid.");
        }
        ...
        if (object == null || !(object instanceof Register)) {
            throw new MachineReaderException(
                    getCurrentLine() + "The destinations attribute "
                            + "of Arithmetic microinstruction \"" + name +
                            "\" is not valid.");
        }
        ...
        Arithmetic c = new Arithmetic(name, type, source1, source2,
    ...
    public void startTransferRtoR(Attributes attrs) {
        ...
        if (object == null || !(object instanceof Register)) {
            throw new MachineReaderException(
                    getCurrentLine() + "The source attribute "
        ...
        if (object == null || !(object instanceof Register)) {
            throw new MachineReaderException(
                    getCurrentLine() + "The dest attribute "
                            + "of TransferRtoR microinstruction \"" + name +
                            "\" is not valid.");
        }
        ...
        try {
            ...
            throw new MachineReaderException(
                    getCurrentLine() + "The numBits value of the " +
        ...
        try {
            ...
            throw new MachineReaderException(
                    getCurrentLine() + "The srcStartBit value of the " +
                            "TransferRtoR microinstruction \"" + name +
        ...
        try {
            ...
            throw new MachineReaderException(
                    getCurrentLine() + "The destStartBit value of the " +
                            "TransferRtoR microinstruction \"" + name +
        ...
        if (destStartBit + numBits > dest.getWidth()) {
            throw new MachineReaderException(
                    getCurrentLine() + "The destination bits of the " +
                            "TransferRtoR microinstruction \"" + name +
                            "\" are out of range for the destination register.");
        }
        if (srcStartBit + numBits > source.getWidth()) {
            throw new MachineReaderException(
                    getCurrentLine() + "The source bits of the " +
                            "TransferRtoR microinstruction \"" + name +
                            "\" are out of range for the source register.");
        }

        TransferRtoR c = new TransferRtoR(name, source, srcStartBit, dest,
    ...
    public void startTransferRtoA(Attributes attrs) {
        ...
        if (object == null || !(object instanceof Register)) {
            throw new MachineReaderException(
                    getCurrentLine() + "The index attribute "
                            + "of TransferRtoA microinstruction \"" + name +
                            "\" is not valid.");
        }
        ...
        TransferRtoA c =
                new TransferRtoA(name, source, srcStartBit, dest, destStartBit,
                        numBits, index, indexStart, indexNumBits);
        String id = attrs.getValue("id");
        components.put(id, c);
    ...
    public void startTransferAtoR(Attributes attrs) {
        ...
        TransferAtoR c = new TransferAtoR(name, source, srcStartBit,
                dest, destStartBit, numBits,
                index, indexStart, indexNumBits);
        String id = attrs.getValue("id");
        components.put(id, c);
    ...
    public void startShift(Attributes attrs) {
        ...
        if (source.getWidth() != dest.getWidth()) {
            throw new MachineReaderException(
                    getCurrentLine() + "The source and destination "
                            + "registers of the Shift microinstruction \"" + name +
        ...
        try {
            ...
            throw new MachineReaderException(
                    getCurrentLine() + "The distance value of the " +
        ...
        Shift c = new Shift(name, source, dest, type, direction, distance);
        String id = attrs.getValue("id");
        components.put(id, c);
    ...
    public void startBranch(Attributes attrs) {
        ...
        try {
            ...
            throw new MachineReaderException(
                    getCurrentLine() + "The amount value of the " +
                            "Branch microinstruction \"" + name +
                            "\" must be an integer, not \"" + amountString + "\".");
        }

        Branch c = new Branch(name, amount, machine.getControlUnit());
        String id = attrs.getValue("id");
        components.put(id, c);
    ...
    public void startLogical(Attributes attrs) {
        ...
        if (!(source1.getWidth() == source2.getWidth() &&
                source2.getWidth() == destination.getWidth())) {
            throw new MachineReaderException(
                    getCurrentLine() + "The two source and destination "
                            + "registers of Logical microinstruction \"" + name +
    ...
    public void startSet(Attributes attrs) {
        ...
        try {
            ...
            throw new MachineReaderException(
                    getCurrentLine() + "The start value of the " +
                            "Set microinstruction \"" + name +
        ...
        if (start + numBits > register.getWidth()) {
            throw new MachineReaderException(
                    getCurrentLine() + "The register bits of the " +
                            "Set microinstruction \"" + name +
        ...
        try {
            ...
            throw new MachineReaderException(
                    getCurrentLine() + "The value attribute of the " +
                            "Set microinstruction \"" + name +
        ...
        CpusimSet c = new CpusimSet(name, register, start, numBits, Long.valueOf(value));
        String id = attrs.getValue("id");
        components.put(id, c);
    ...
    public void startTest(Attributes attrs) {
        ...
        if (start + numBits > register.getWidth()) {
            throw new MachineReaderException(
                    getCurrentLine() + "The bits of the " +
                            "Test microinstruction \"" + name +
        ...
        try {
            ...
            throw new MachineReaderException(
                    getCurrentLine() + "The omission attribute of the " +
                            "Test microinstruction \"" + name +
                            "\" must be an integer, not \"" + omissionString + "\".");
        }

        Test c = new Test(name, register, start, numBits, comparison, Long.valueOf(value),
                omission, machine.getControlUnit());
        String id = attrs.getValue("id");
        components.put(id, c);
    ...
    public void startDecode(Attributes attrs) {
        ...
        if (object == null || !(object instanceof Register)) {
            throw new MachineReaderException(
                    getCurrentLine() + "The ir attribute "
                            + "of the Decode microinstruction \"" + name
                            + "\" is not valid.");
        }
        Register ir = (Register) object;

        Decode c = new Decode(name, ir, machine);
        String id = attrs.getValue("id");
        components.put(id, c);
    ...
    public void startIO(Attributes attrs) {
        ...
        if ("character".equals(type)) {
            throw new MachineReaderException(getCurrentLine() +
                    "IO microinstructions of type "
                    + "character are not yet implemented.  The microinstruction \""
                    + name + "\" is not valid.");
        }
        ...
        if (object == null || !(object instanceof Register)) {
            throw new MachineReaderException(
                    getCurrentLine() + "The buffer attribute "
        ...
        if (channelID == null || channelID.equals("")
            ...
            if (object == null) {
                throw new MachineReaderException(getCurrentLine() +
                        ...
                        + "of the IO microinstruction \"" + name +
                        "\" is not valid.");
            }
            connection = (IOChannel) object;
        }

        IO c = new IO(name, type, buffer, direction, connection);
        String id = attrs.getValue("id");
        components.put(id, c);
    ...
    public void startMemoryAccess(Attributes attrs) {
        ...
        if (object == null || !(object instanceof RAM)) {
            throw new MachineReaderException(
                    getCurrentLine() + "The memory attribute "
        ...
        */
        ...
        if (object == null || !(object instanceof Register)) {
            throw new MachineReaderException(
                    getCurrentLine() + "The address register attribute "
                            + "of the MemoryAccess microinstruction \"" + name +
                            "\" is not valid.");
        }
        Register address = (Register) object;

        MemoryAccess c = new MemoryAccess(name, direction, memory, data,
                address);
        String id = attrs.getValue("id");
        components.put(id, c);
    ...
    public void startSetCondBit(Attributes attrs) {
        ...
        if (object == null || !(object instanceof ConditionBit)) {
            throw new MachineReaderException(
                    getCurrentLine() + "The bit attribute "
    ...
    public void startMachineInstruction(Attributes attrs) {
        /*
         * For backward compatability, I need to first check for
         * a lack of fields and, if so, add fields with numbers as
         * names here.
         */
//        if (machine.getFields().size() == 0) {
//            for (int i = 1; i <= 16; i++) {
//                String name1 = "" + i;
//                Field f1 = new Field(name1, Field.Type.required, i,
//                        Field.Relativity.absolute,
//                        new ArrayList<FieldValue>(),
//                        0, true);
//                machine.getFields().add(f1);
//                fields.put(name1, f1);
//                String name2 = "-" + i;
//                Field f2 = new Field(name2, Field.Type.ignored, i,
//                        Field.Relativity.absolute,
//                        new ArrayList<FieldValue>(),
//                        0, true);
//                machine.getFields().add(f2);
//                fields.put(name2, f2);
//            }
//        }
        ...
        try {
            ...
            throw new MachineReaderException(
                    getCurrentLine() + "The opcode value " +
        ...
        if (currentFormat == null)
            currentFormat = ""; //for backward compatability--
        // to be filled by field lengths
        
        currentInstructionFormat = attrs.getValue("instructionFormat");
        
        currentAssemblyFormat = attrs.getValue("assemblyFormat");
        ...
        currentInstruction =
                new MachineInstruction(name, opcode, currentFormat, machine);
            ...
            currentInstruction = new MachineInstruction(name, opcode, 
                    ...
                    Convert.xmlToColorsList(instrColors), Convert.xmlToColorsList(assemblyColors),
                    machine);
        }
    ...
    public void endMachineInstruction() {
        try {
            //These were here, not sure why they are/were necessary
            //currentInstruction.setInstructionFields(Convert.formatStringToFields(currentFormat, machine));
            //currentInstruction.setAssemblyFields(Convert.formatStringToFields(currentFormat, machine));
            
            //The next line is already performed by the setFormat method above
            //Validate.getFieldsFromFormat(currentInstruction.getFormat(),
            //                             machine.getFields());
            ...
            throw new MachineReaderException(
                    (locator == null ? "" : "The error is in the MachineInstruction" +
                            " element ending at line ") +
    ...
    public void startFieldLength(Attributes attrs) {
        ...
        try {
            ...
            throw new MachineReaderException(
                    getCurrentLine() + "Field lengths of" +
                            " machine instruction \"" +
    ...
    public void startRegisterRAMPair(Attributes attrs) {
        ...
        if (object == null || !(object instanceof RAM)) {
            throw new MachineReaderException(
                    getCurrentLine() + "The ram attribute \""
    ...
    public void startLoadingInfo(Attributes attrs) {
        ...
        if (object == null || !(object instanceof RAM)) {
            throw new MachineReaderException(
                    getCurrentLine() + "The ram attribute \""
                            + ramID + "\" of a LoadingInfo element is not a valid RAM ID.");
        }
        RAM ram = (RAM) object;
        ...
        try {
            ...
            throw new MachineReaderException(
                    getCurrentLine() + "The starting address "
